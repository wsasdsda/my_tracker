...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                template_frames, template_anno, meta_obj_train, template_event_img_frame, template_event_voxel = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict)
                search_frames, search_anno, meta_obj_test, search_event_img_frame, search_event_voxel = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict)
                ...
                data = TensorDict({'template_images': template_frames,
                                   ...
                                   'template_event_voxel': template_event_voxel,
                                   'search_event_voxel': search_event_voxel
                                   })
