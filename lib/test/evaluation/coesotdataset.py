...
class COESOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        frames_event_path = '{}/{}/{}'.format('/wangx/DATA/Dataset/COESOT/new_voxel2/test/', sequence_name, sequence_name+'_5binvoxel')
        frame_event_list = [frame for frame in os.listdir(frames_event_path) if frame.endswith(".npz")]
