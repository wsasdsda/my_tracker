...
if __name__ == '__main__':
    ...
    parser.add_argument('--parameter_name', type=str, default='apmtrack_coesot', help='coesot or fe108 or fe or eed.')
    ...
    """apmtrack"""
    trackers.extend(trackerlist(name='apmtrack', parameter_name=args.parameter_name, dataset_name=dataset_name,
                                run_ids=None, display_name='APMTrack256'))
